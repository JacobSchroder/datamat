...
# Formulae — CLI tools and languages
brew "awscli"                       # AWS command-line interface
brew "cdk"                          # AWS CDK CLI
brew "conftest"                     # Policy testing for config files
...
brew "opentofu"                     # Terraform-compatible IaC tool
...
brew "sqlc"                         # Generate Go code from SQL
brew "tailwindcss"                  # Tailwind CSS CLI
